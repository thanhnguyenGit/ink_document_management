...
pub use self::permission_control::{ConfirmationStatus, Multisig, Transaction};
...
pub mod permission_control {
    ...
    pub struct Transaction {
        ...
        /// If set to true the transaction will be allowed to re-enter the permission_control
